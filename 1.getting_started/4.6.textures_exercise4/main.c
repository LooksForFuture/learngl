...
int main(void)
{
	...
	float mixValue = 0.5f; /* mix value between two textures */
	int mixValueLocation;
	...
	mixValueLocation = glGetUniformLocation(shaderProgram, "mixValue");
